...
class HarmonizationConfigPanel(QDialog):
    ...
    def __init__(self, win_name):
        ...
        type_list = ('i', 'V', 'L', 'I', 'T', 'Y', 'X',)
        self.grid_icons = QGridLayout()
        self.grp_icons = QButtonGroup()
        for k in range(7):
            icon_fpath = f'./resource/template_type_{k}_{type_list[k]}.png'
            ...
            rdb_template_type.setIcon(QIcon(QPixmap(icon_fpath)))
            rdb_template_type.setIconSize(QSize(w // 4, h // 2,))
            if k == 0:
        ...
        self.sld_resize_ratio.setValue(20)
        self.lbl_show_slider_value = QLabel(' 1.00')
